...
{
    class BillboardsIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("BillboardsIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentHeader(Document document)
        {
            ...
            paragraph.Range.Text = "Billboards";
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<Billboard> billboardsWebData = new List<Billboard>();
            billboardsWebData = Web_Data.BillboardsWebData.GetBillboards();
            ...
            table.Rows[table.Rows.Count].Cells[2].Range.Text = "Location";
            table.Rows[table.Rows.Count].Cells[3].Range.Text = "Latitude";
            table.Rows[table.Rows.Count].Cells[4].Range.Text = "Longitude";
            ...
            // add table data rows
            foreach (Billboard billboard in billboardsWebData)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = billboard.Name.ToString();
                table.Rows[table.Rows.Count].Cells[2].Range.Text = billboard.Location.ToString();
                table.Rows[table.Rows.Count].Cells[3].Range.Text = billboard.Latitude.ToString();
                table.Rows[table.Rows.Count].Cells[4].Range.Text = billboard.Longitude.ToString();
                table.Rows[table.Rows.Count].Cells[5].Range.Text = billboard.AdFlowchartDiagramData.ToString();
